...
public class DocumentMapper {
    ...
    public static Document toEntity(String title, String documentType,
                                    ...
                                    Lawyer lawyer) throws IOException {
    ...
    public static DocumentResponseDTO toDTO(Document document) {
        ...
        if (document.getLegalCase() != null) dto.setCaseId(document.getLegalCase().getId());
        if (document.getLawyer() != null)    dto.setLawyerId(document.getLawyer().getId());
        return dto;
    }
}
